...
export function GlobeDemo() {
  ...
  return (
    <div className="relative w-full h-[500px] md:h-[600px] bg-white dark:bg-black flex items-center justify-center">
      <div className="w-full h-full max-w-4xl mx-auto relative">
        <motion.div
          ...
          className="absolute top-8 left-0 right-0 z-20 text-center px-4"
        >
