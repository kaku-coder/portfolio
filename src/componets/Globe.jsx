...
export function World(props) {
  ...
  return (
    <Canvas scene={scene} camera={new PerspectiveCamera(50, aspect, 180, 1800)}>
      ...
      {/* PASS SCALE HERE */}
      <Globe {...props} scale={scale} />

// In your Globe.jsx file, update the OrbitControls component:
<OrbitControls
  enablePan={false}
  enableZoom={false}
  enableRotate={true}
